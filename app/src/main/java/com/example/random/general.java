...
public class general extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getQuestionList()
    {
        ...
        questionsList.add(new questions("Who is the only president to have been elected for two consecutive terms","Rajendra Prasad","Zakir Hussain","APJ Abdul Kalam","Sarvapalli RAdhakrishnan",1));
        questionsList.add(new questions("Kanha National Park is famous for","Elephant","Rhinocerus","Cows","Tigers",4));
        questionsList.add(new questions("Which city of Maharashtra is cknown as OXFORD OF THE EAST","Mewar","Pune","Nashik","Mumbai",2));
        questionsList.add(new questions("A R rehman is associated with","Literature","Music","Film Direction","Business",2));
        questionsList.add(new questions("Who started 2011 anti corruption movement in India to enforce jan lokpal bill","Mamta Banerjee","Medha Patkar","Atul Maheshwari","Anna Hazare",4));
    ...
    private void changeQuestion() {
        ...
        {
            //go to result
            Intent intent=new Intent(general.this,result.class);
