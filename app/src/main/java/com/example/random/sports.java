...
public class sports extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getQuestionList()
    {
        ...
        questionsList.add(new questions("Who is first Indian woman to win an Asian GAmes gold in 400m run","P T Usha","K Malleshwari","M L Valsamna","Saina Nehwal",1));
        questionsList.add(new questions("William Jones Cup is associated with","Football","Hockey","Basketball","Batminton",3));
        questionsList.add(new questions("Cue Ball,Break shot,pool table are terms associated with","Sqash","Billiard","Table tenis","Golf",2));
        questionsList.add(new questions("Sultan Azlan Shah Cup is related to","Badminton","Hockey","Golf","Cricket",2));
        questionsList.add(new questions("First bowler to take a hatrick in T20 International","Tim Southee","Lasith Malinga","Brett Lee","ABD",3));
